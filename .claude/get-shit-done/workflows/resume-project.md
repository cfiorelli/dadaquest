...
<required_reading>
@/Users/lolm/dadaquest/.claude/get-shit-done/references/continuation-format.md
</required_reading>
...
```bash
INIT=$(node "/Users/lolm/dadaquest/.claude/get-shit-done/bin/gsd-tools.cjs" init resume)
