...
export const ITEM_DEFS = [
  ...
  },
  {
    ...
    stats: {
      weaponCooldown: 0.24,
      weaponProjectileSpeed: 15.5,
      weaponProjectileLife: 1.0,
      weaponStunSec: 0.9,
  ...
  },
  {
    ...
    stats: {
      weaponCooldown: 0.62,
      weaponProjectileSpeed: 13.0,
      weaponProjectileLife: 1.8,
      weaponStunSec: 1.2,
  ...
  },
  {
    ...
    stats: {
      weaponCooldown: 0.34,
      weaponProjectileSpeed: 12.4,
      weaponProjectileLife: 1.2,
      weaponStunSec: 1.0,
      weaponKnockback: 1.2,
    },
    visualTag: 'fan',
