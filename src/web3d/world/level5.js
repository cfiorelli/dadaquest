...
export const LEVEL5 = compileAuthoredEraLayout({
    ...
    sectors: [
      {
        ...
        decorBlocks: [
          ...
          // Water zone floor marker — covers deepWaterPocket footprint (X 28-44, Z 26-34)
          block('water_zone_marker', 36, 0.005, 30, 16, 0.01, 8, {
            rgb: [40, 110, 210],
            roughness: 0.6,
            emissiveScale: 0.28,
            alpha: 0.45,
  ...
  airBubblePickups: [
    { name: 'bubble_se_01', x: 32, y: 1.8, z: 29, radius: 0.9 },
    { name: 'bubble_se_02', x: 40, y: 1.8, z: 31, radius: 0.9 },
  ],
  eelRails: [],
  vents: [],
  jellyfish: [
